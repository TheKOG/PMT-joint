...
from engine import GeneralMovingAverage, get_dataset, get_text_features, prompts_train, evaluate_all_pmp
...
def main(args: argparse.Namespace):
    ...
    clip_pmp=CustomCLIP(clip_model=clip_model,classnames=train_class_names,cfg=setup_cfg(args),device=device)
    ...
    for test_loader in test_loaders:
        test_loader["prefixes"],test_loader["suffixes"]=clip_pmp.prompt_learner.get_pre_suf(test_loader["class_names"],clip_model)
    ...
    if args.phase == "train":
        ...
        best_val_acc1 = evaluate_all_pmp(clip_pmp, val_loader, test_loaders, args, writer, device)
        ...
        for epoch in range(args.epochs):
            ...
            # train for one epoch
            prompts_train(train_iter, clip_pmp, bma_classifier, optimizer, lr_scheduler, epoch, args, writer, device)

            # evaluate all
            val_acc1 = evaluate_all_pmp(clip_pmp, val_loader, test_loaders, args, writer, device)
            ...
            if val_acc1 > best_val_acc1:
                ...
                clip_pmp.prompt_learner.Save()

        print("Training completed.")

    print("Evaluate best model:")
    evaluate_all_pmp(clip_pmp, val_loader, test_loaders, args, writer, device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pmp_cfg_file', type=str, default='./configs/vit_b16_c16.yaml', help='Path to the pmp_cfg_file YAML file.')
